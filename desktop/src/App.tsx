...
function App() {
  ...
  return (
    <div key={showCounter} className="h-full w-full p-2 flex animate-overlay-in">
      <div className="flex-1 flex flex-col rounded-[20px] overflow-hidden bg-transparent border border-white/20 ring-1 ring-inset ring-white/10 shadow-2xl relative">
